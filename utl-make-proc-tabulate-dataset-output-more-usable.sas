...
This solution may only work with character classification variablles?                                           
                                                                                                                
I know there are other procedures that can do this more easily, but tabulate offer s rich                       
set of hierachies and functions.                                                                                
                                                                                                                
It is a shame that tabulate does not honor ods output!!                                                         
Anoither way to do this is output to excel and then input the excel output?                                     
